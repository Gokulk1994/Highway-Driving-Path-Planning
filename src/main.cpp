...
// for convenience
using nlohmann::json;#include <uWS/uWS.h>
#include <fstream>
#include <iostream>
#include <string>
#include <vector>
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for(int i =0; i < sensor_fusion.size(); i++){
            ...
            int check_car_lane = floor(check_car_d / 4);
            
            check_car_s += ((double)prev_path_Size*0.02*velocity);
            ...
            else if((check_car_lane == lane + 1) && (lane + 1 > 2))
            {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for(int i =0; i < sensor_fusion.size(); i++){
            ...
            if((check_car_d < (2+lane*4+2)) && (check_car_d > (2+lane*4-2))){
